...
//    forgetBtn.setTitle(NSLocalizedString("2333", comment: ""), for: UIControlState())
...
//    NSString *text = [resourceBundle localizedStringForKey:@"Hello Framework" value:@"" table:nil];
    ...
    let bundleURL = containingBundle.url(forResource: "CocoapodsDemo", withExtension: "bundle")
    let bundle = Bundle(url: bundleURL!)
    
    let text = bundle?.localizedString(forKey: "ENTER_THE_GESTURE_PASSWORD", value: "", table: nil)
    
    let forgetBtn: UIButton = UIButton(type: .custom)
    forgetBtn.addTarget(self, action: #selector(LockViewController._forgetBtnClick), for: .touchUpInside)
//    forgetBtn.setTitle(NSLocalizedString("FORGET_PASSWORD", comment: ""), for: UIControlState())
    forgetBtn.setTitle(text, for: UIControlState())
    forgetBtn.setTitleColor(kForgetBtnColorNormal, for: UIControlState())
    forgetBtn.titleLabel?.font = UIFont.systemFont(ofSize: kSmallFontSize)
...
//      _avatarImageView.WTK_setAvatarForUser(me, length: 35)
      ...
      _avatarImageView.backgroundColor = .red
      
      
      
//      let containingBundle = Bundle(for: type(of: self))
//      let path = containingBundle.path(forResource: "ico_person_default@2x.png", ofType: nil, inDirectory: "CocoapodsDemo.bundle")
//      _avatarImageView.image = UIImage(contentsOfFile: path!)
      
      
//      let containingBundle = Bundle(for: type(of: self))
//      let bundleURL = containingBundle.url(forResource: "CocoapodsDemo", withExtension: "bundle")
//      let bundle = Bundle(url: bundleURL!)
      _avatarImageView.image = UIImage(named: "CocoapodsDemo.bundle/ico_person_default@2x.png")
